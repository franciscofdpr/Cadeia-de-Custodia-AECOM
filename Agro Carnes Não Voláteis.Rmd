...
tabela_1 = dados %>%
  dplyr::filter(amostra == params$amostra,
                ...
                etapa %in% c("Coleta do(s) produto(s) agropecuário(s)", # Etapa 01
                             ...
                             "Transporte do(s) produto(s) agropecuário(s) entre bases de apoio",# Etapa 05
                             "Recebimento e armazenamento do(s) produto(s) agropecuário(s) entre bases de apoio"))%>% # Etapa 06
  ...
  dplyr::mutate(id = ifelse(etapa == "Pré-preparo e armazenamento dos(s) produtos agropecuários - carnes", "4", id))%>%
...
tabela_2 = dados %>%
  dplyr::filter(amostra == params$amostra,
                ...
                etapa %in% c("Entrega do(s) produto(s) agropecuário(s) para o transporte até o laboratório",# Etapa 07
                             "Recebimento do(s) produto(s) agropecuário(s) para o transporte até o laboratório",# Etapa 08
                             "Transporte do(s) produto(s) agropecuário(s) para o laboratório",# Etapa 09
                             "Entrega do(s) produto(s) agropecuário(s) transportados(s)",# Etapa 10
                             "Recebimento do(s) produto(s) agropecuário(s) transportados(s)",# Etapa 11
                             "Cadastro e armazenamento do(s) produto(s) agropecuário(s) no laboratório",# Etapa 12
                             "Transferência de equipamento de armazenamento do(s) produto(s) agropecuário(s)"))%>%# Etapa 13
  dplyr::select(etapa, alimento, data, hora, responsavel, assinatura, cod_equipamento_armazenamento, 
                temperatura_min, temperatura_max, temperatura_entrega_recebimento, outras_informacoes)%>%
  dplyr::mutate(id="")%>%
...
tabela_3 = dados %>%
  dplyr::filter(amostra == params$amostra,
                ...
                etapa %in% c("Geração de amostra e armazenamento",# Etapa 14
                             "Transferência de equipamento de armazenamento de amostra",# Etapa 15
                             "Geração de contraprova e armazenamento",# Etapa 16
                             "Transferência de equipamento de armazenamento de contraprova",# Etapa 17
                             "Liofilização da amostra e armazenamento",# Etapa 18
                             "Preparo da amostra e armazenamento",# Etapa 19
                             "Análise da amostra",# Etapa 20
                             "Descarte da amostra"))%>% # Etapa 21
...
tabela_4 = dados %>%
  dplyr::filter(amostra == params$amostra,
                ...
                etapa %in% c("Envio da(s) amostra(s) para transporte", # Etapa 22
                             "Transporte da(s) amostra(s)", # Etapa 23
                             "Entrega da(s) amostra(s) transportada(s)", # Etapa 24
                             "Recebimento da(s) amostra(s) transportada(s)", # Etapa 25
                             "Cadastro da amostra e armazenamento", # Etapa 26
                             "Preparo da amostra e armazenamento", # Etapa 27
                             "Análise da amostra", # Etapa 28
                             "Descarte da amostra"))%>% # Etapa 29
  dplyr::select(etapa, subs_quimica, data, hora, responsavel, assinatura, cod_equipamento_armazenamento, 
                temperatura_min, temperatura_max, temperatura_entrega_recebimento,outras_informacoes)%>%
  dplyr::mutate(id="")%>%
...
tabela_5 = dados %>%
  dplyr::filter(amostra == params$amostra,
                ...
                etapa %in% c("Envio da(s) amostra(s) para transporte", # Etapa 30
                             "Transporte da(s) amostra(s)", # Etapa 31
                             "Entrega da(s) amostra(s) transportada(s)", # Etapa 32
                             "Recebimento da(s) amostra(s) transportada(s)", # Etapa 33
                             "Cadastro da amostra e armazenamento", # Etapa 34
                             "Preparo da amostra e armazenamento",# Etapa 35
                             "Análise da amostra",# Etapa 36
                             "Descarte da amostra"))%>% # Etapa 37
  dplyr::select(etapa, subs_quimica, data, hora, responsavel, assinatura, cod_equipamento_armazenamento, 
                temperatura_min, temperatura_max, temperatura_entrega_recebimento, outras_informacoes)%>%
  dplyr::mutate(id="")%>%
  dplyr::mutate(id = ifelse(etapa == "Envio da(s) amostra(s) para transporte", "1", id))%>%
